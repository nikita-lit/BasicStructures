...
try:
    ...
    lõplik_hind = hind * (1 - soodustus)
    print(f"Lõplik hind on: {lõplik_hind:.2f} euro")
except Exception as e:
    print(f"ERROR: {e}")
...
try:
    ...
    if sugu == "mees" and 16 <= vanus <= 18:
        ...
        print("Vanust ei küsita, kuna sa oled naine.")
    else:
...
try:
    ...
    bussi_suurus = int(input("Sisesta ühe bussi kohtade arv: "))
